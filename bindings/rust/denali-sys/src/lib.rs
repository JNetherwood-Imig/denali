...
impl DwlDisplayError {
    ...
    pub const DWL_DISPLAY_ERROR_EPOLL_FD_LIMIT_REACHED: Self = Self(7);
    pub const DWL_DISPLAY_ERROR_EPOLL_NO_MEM: Self = Self(8);
    pub const DWL_DISPLAY_ERROR_UNKNOWN: Self = Self(9);
}
